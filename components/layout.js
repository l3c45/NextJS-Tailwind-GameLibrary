...
const Layout = ({ children }) => {
  return (
    <div className="bg-[#4a0339] flex items-center flex-col justify-between h-screen ">
      <Head>
      ...
      <header className="bg-zinc-900 relative w-full px-4 flex items-center justify-center h-1/5">
